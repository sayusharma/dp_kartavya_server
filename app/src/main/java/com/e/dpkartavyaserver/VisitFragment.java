...
import com.e.dpkartavyaserver.Adapter.TodayVisitAdapter;
 ...
 */
public class VisitFragment extends Fragment implements TodayVisitAdapter.OnItemClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        no = view.findViewById(R.id.totalVisitToday);
        recyclerView = view.findViewById(R.id.todayVisitRecycler);
        ...
        databaseReference.orderByChild("date").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot dataSnapshot1:dataSnapshot.getChildren()){
                    ...
                    if (verifySnr.getDate().equals(currentDate))
                        arrayList.add(verifySnr);
                }
                if(arrayList.isEmpty()){
                    Toast.makeText(getContext(),"NO VISITS FOUND!",Toast.LENGTH_SHORT).show();
                }
                else
                {
    ...
    public void setAdapter(){
        ...
        TodayVisitAdapter todayVerificationAdapter = new TodayVisitAdapter(getContext(),arrayList,this);
